module Glazier
  module ApiCredentials
    if Rails.env.test?
      ...
      GITHUB_CLIENT_ID = ENV['GLAZIER_GITHUB_CLIENT_ID'] || (raise KeyError, 'GLAZIER_GITHUB_CLIENT_ID')
      GITHUB_CLIENT_SECRET = ENV['GLAZIER_GITHUB_CLIENT_SECRET'] || (raise KeyError, 'GLAZIER_GITHUB_CLIENT_ID')
    end
  end
end
